<template>
	<view>
		...
		<view class="" style="border-bottom: 1rpx solid #F5F5F5;" v-for="(i,k) in dynamic_list" :key="k">
			<view class="" style="display: flex;align-items: center;justify-content: space-between;padding: 28rpx 24rpx;">
				<view class="" style="display: flex;align-items: center;">
					<image :src="i.avatar" mode="aspectFill" style="width: 110rpx;height: 110rpx;border-radius: 50%;"></image>
					<view class="" style="margin-left: 14rpx;">
						<view class="" style="display: flex;align-items: center;">
							...
							<view class=""
								style="width: 68rpx;height: 30rpx;background: #EEEEEE;border-radius: 15rpx;font-size: 21rpx;display: flex;align-items: center;justify-content: center;margin-left: 22rpx;" :style="{color:i.gender==2 ? '#FF738E' : '#56A0FF'}">
								<image :src="i.gender==2 ? '/static/home/nv.png' : '/static/home/nan.png'" mode=""
									style="width: 24rpx;height: 24rpx;padding-right: 5rpx;"></image>
								<text>{{i.age}}</text>
							</view>
						</view>
				...
				<view class="" @tap="id=i.id,show=true">
					<image src="/static/user/del.png" mode="" style="width: 30rpx;height: 30rpx;"></image>
				</view>
			</view>
			...
			<!-- <view class="" style="display: flex;align-items: center;flex-wrap: wrap;margin: 0 25rpx;">
				<view class="" style="width: 33.3%;text-align: center;margin-top: 10rpx;" v-for="i in 4">
					<image src="/static/home/mei.png" mode="aspectFill" style="width: 230rpx;height: 230rpx;border-radius: 15rpx;"></image>
				</view>
			</view>
			<view class="" style="width: 420rpx;height: 508rpx;background: url(/static/home/mei.png) no-repeat;background-size: 100% 100%;border-radius: 20rpx;display: flex;align-items: center;justify-content: center;margin: 22rpx 29rpx;">
		...
		<u-modal v-model="show" :content="content" title="" :show-cancel-button="true" @confirm="confirm"></u-modal>
	</view>
</template>
		...
		methods: {
			...
			getdong(e){
				...
				this.util.request('dynamic/dynamic_list',{
					page:this.page,
					token: uni.getStorageSync('user').token,
					to_id:uni.getStorageSync('user').id
				}).then(res=>{
