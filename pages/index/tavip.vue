			...
			<view class="" style="display: flex;align-items: center;padding-top: 209rpx;padding-left: 31rpx;">
				...
				<view class="" style="margin-left: 20rpx;">
					<view class="" style="display: flex;align-items: center;">
						...
						<view class=""
							style="margin-left: 11rpx;height: 40rpx;background: #F5F5F5;border-radius: 10rpx;text-align: center;line-height: 40rpx;font-size: 24rpx;color: #666666;padding: 0 10rpx;" v-if="userinfo.vip_type!=0">
							{{allText.我的页.会员用户}}
						</view>
					</view>
					...
					<view class="" style="display: flex;align-items: center;">
						<view class="" v-for="(i,k) in viplist" :key="k" style="margin-left: 30rpx;">
							<view :class="current1==k ? 'xzsbtn' : 'zsbtn'" @tap="current1=k">
								...
								<view class="neibtn">
									{{allText.我的页.每日仅需}}{{i.old_price}}元
								</view>
	...
	export default {
		...
		methods: {
			kai(){
				...
				if (!selected || !selected.vip_id || !this.user_id) {
